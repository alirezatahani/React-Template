      ...
      <Col xs={12}>
        <ImagesContainer>
          ...
          <Col xs={8}>
            ...
            <Space align={'center'}>
              <Typography variant='body1'>              
                Use this space to elaborate on your headline and connect with your visitors. You can build on the first idea or add your second point. Now that you've got your visitors' attention,
                let them know what they can expect, and encourage them to explore your site.
              </Typography>
            </Space>
            ...
            <Col xs={12}>
              <Row>
                <Col xs={4}>
                  ...
                  <br/>
                  <Space align={'center'}><Typography variant='h4'>ADD YOUR TITLE</Typography></Space>
                  <Space align={'center'}><Price variant='body1'>$6.99</Price></Space>
                </Col>
                <Col xs={4}>
                  <Space align={'center'}>
            ...
            <br/>
            <Space align={'center'}>
            <Typography>Use this space to elaborate on your headline and connect with your visitors.</Typography>
            </Space>
            <br/>
            <Space align={'center'}><MenuButton color='danger'>MENU</MenuButton></Space>
          </Col>
          <Col xs={2}></Col>
        </ImagesContainer>
      </Col>

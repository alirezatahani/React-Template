  ...
  Button: [
    {
      id: 1,
      name: 'Button',
      style: { backgroundColor: 'yellow', margin: '20px', padding: '20px' },
    },
    {
      id: 2,
      name: 'Button',
    ...
    },
    {
      id: 3,
      name: 'Button',
      style: { backgroundColor: 'blue', margin: '20px', padding: '20px 40px' },
    },
    {
      id: 4,
      name: 'Button',
    ...
    },
    {
      id: 5,
      name: 'Button',
      style: { backgroundColor: 'brown', margin: '20px', padding: '20px' },
    },
  ],
};
